...
echo "addnode=159.65.166.180" >> $CONF_DIR/$CONF_FILE
echo "addnode=103.95.197.122" >> $CONF_DIR/$CONF_FILE
echo "addnode=103.95.197.75" >> $CONF_DIR/$CONF_FILE
echo "addnode=46.101.220.249" >> $CONF_DIR/$CONF_FILE
echo "addnode=104.236.105.113" >> $CONF_DIR/$CONF_FILE
